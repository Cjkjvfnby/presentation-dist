...
..
  ...
  Современные IDE позволяют смотреть в исходники кода с которым вы работаете и в большинстве случаев документация созданная по коду не используется разработчиками.
