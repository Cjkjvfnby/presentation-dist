...
..
  ...
  Переиспользование это важный приём при написание кода. Который позволят значительно сократить время разработки.
  ...
  Перед тем как я перейду к следующему слайду, какие способы вы знаете для использования чужого кода?
